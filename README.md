...
[@reelase-please-test](https://www.npmjs.com/org/elgato-stream-deck) is a collection of libraries for interfacing with the various models of the [Elgato Stream Deck](https://www.elgato.com/en/gaming/).  
...
The existing implementations are a light wrapper around the platform agnostic [`@reelase-please-test/core`](https://npm.im/@reelase-please-test/core). You can use your own HID implementation and device scanning/opening logic and reuse all the streamdeck bits.
